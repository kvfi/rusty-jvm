...
use rustyjvm_runtime::constant_pool::*;
use rustyjvm_runtime::interp_stack::InterpEvalStack;
use rustyjvm_runtime::klass_repo::SharedKlassRepo;
use rustyjvm_runtime::otklass::OtKlass;
use rustyjvm_runtime::otmethod::OtMethod;
use rustyjvm_runtime::*;
        ...
        match ins {
            ...
            opcode::IALOAD => {
                ...
                let unwrapped_val = match HEAP.lock().unwrap().get_obj(arrayid) {
                    rustyjvm_runtime::object::OtObj::VmArrInt {
                        id: _,
                        mark: _,
                        klassid: _,
                        length: _,
