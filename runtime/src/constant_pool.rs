...
pub const ACC_SUPER: u16 = 0x0020; // (Class) Treat superclass Functions specially when invoked by the invokespecial instruction.
...
pub const ACC_SYNCHRONIZED: u16 = 0x0020; // (Function) Declared synchronized; invocation is wrapped by a monitor use.
pub const ACC_BRIDGE: u16 = 0x0040; // (Function) A bridge, generated by the compiler.
pub const ACC_VARARGS: u16 = 0x0080; // (Function) Declared with variable number of arguments.
pub const ACC_NATIVE: u16 = 0x0100; // (Function) Declared native; implemented in a language other than Java.
pub const ACC_ABSTRACT_M: u16 = 0x0400; // (Function) Declared abstract; no implementation is provided.
pub const ACC_STRICT: u16 = 0x0800; // (Function) Declared strictfp; floating-point mode is FP-strict.
...
pub const CP_FunctionREF: u8 = 10;
pub const CP_INTERFACE_FunctionREF: u8 = 11;
pub const CP_NAMEANDTYPE: u8 = 12;
pub const CP_FunctionHANDLE: u8 = 15;
pub const CP_FunctionTYPE: u8 = 16;
...
impl FunctionRef {
    pub fn new(clz_idx: u16, nt_idx: u16) -> Self {
        FunctionRef { clz_idx, nt_idx }
    }
}

#[derive(Clone, Copy, Debug)]
pub struct InterfaceFunctionRef {
    pub clz_idx: u16,
    pub nt_idx:  u16,
}

impl InterfaceFunctionRef {
    pub fn new(clz_idx: u16, nt_idx: u16) -> Self {
        InterfaceFunctionRef { clz_idx, nt_idx }
    }
}
...
pub enum CpEntry {
    ...
    InterfaceFunctionRef(InterfaceFunctionRef),
...
impl CpEntry {
    ...
    pub fn name(&self) -> String {
        match *self {
            ...
            CpEntry::FunctionRef(_) => "Functionref".to_string(),
            CpEntry::InterfaceFunctionRef(_) => "Instance_Functionref".to_string(),
